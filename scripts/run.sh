...
python3 ./detr/main.py --dataset_file "custom" --coco_path "./aerial/train" --output_dir "outputs/train" --resume "detr-r50_no-class-head.pth"  --num_classes 4 --epochs 20
...
python3 ./detr/main.py --dataset_file "custom" --coco_path "./aerial/rain-0.5/train" --output_dir "outputs/rain-0.5" --resume "outputs/train/checkpoint.pth"  --num_classes 4 --epochs 40
python3 ./detr/main.py --dataset_file "custom" --coco_path "./aerial/snow-0.5/train" --output_dir "outputs/snow-0.5" --resume "outputs/train/checkpoint.pth"  --num_classes 4 --epochs 40
